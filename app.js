...
const riceObPrimaryRef = document.querySelector("#previous-rice-balance-primary");
...
const displayPryExpenditure = document.querySelector("#display-expenditure-pry");
const displayPrimaryBalance = document.querySelector("#display-balance-primary");
...
const displayMiddleExpenditure = document.querySelector("#display-expenditure-middle");
const displayMiddleBalance = document.querySelector("#display-middle-balance");

// ACCUMULATIVE SECTION
const displayTotalOpeningBalance = document.querySelector("#display-total-opening-balance");
const displayTotalIncome = document.querySelector("#display-total-income");
const displayTotalExpenditureRef= document.querySelector("#display-total-expenditure");
const displayClosingBalanceRef = document.querySelector("#display-closing-balance");
...
const displayRicePryConsumed = document.querySelector("#display-rice-consumed-pry");
...
const displayRiceMiddleLifted = document.querySelector("#display-rice-middle-lifted");
const displayRiceMiddleConsumed = document.querySelector("#display-rice-middle-consumed");
const displayRiceMiddleBalance = document.querySelector("#display-rice-middle-balance");

// ACCUMULATIVE RICE DETAILS
const displayRiceAccOb = document.querySelector("#display-rice-total-ob");
const displayRiceAccLifted = document.querySelector("#display-rice-total-lifted");
const displayRiceAccConsumed = document.querySelector("#display-rice-total-consumed");
...
function calculatePrimaryBalance(
    ...
    let primaryBalance = Number(prevBalPrimaryRef) + Number(incomePrimary) - primaryExpenses;
    displayPrimaryBalance.innerText = primaryBalance;
...
function calculateMiddleBalance(
    ...
    displayMiddleBalance.innerText = middleBalance;
    return middleBalance;
}

//sums the total closing balance
function accumulativeClosingBalance(totalOpeningBalance,totalIncome,totalExpenditure) {
...
function calculateAll() {
    ...
    let primaryBalance = calculatePrimaryBalance(prevBalPrimaryRef.value, incomePrimary.value, primaryExpenses);
    let middleBalance = calculateMiddleBalance(prevBalMiddleRef.value, incomeMiddle.value, middleExpenses);
    // Total balance
    accumulativeOpeningBalance(totalOpeningBalance);
        //Total Income 
    accumulativeIncome(totalIncome);
    // Total expenditure
    let totalExpenditure = accumulativeExpenditure(primaryExpenses,middleExpenses);
    // Closing Balance
    accumulativeClosingBalance(totalOpeningBalance,totalIncome,totalExpenditure);
